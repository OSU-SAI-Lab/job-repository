# Smart Segmentation — Few-Shot Instance Segmentation
...
> Split out from the earlier OWLv2/BioCLIP box-detection pipeline, which lives on in
> [`smart-labeller/`](../smart-labeller/).
